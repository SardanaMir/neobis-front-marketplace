  ...
  return (
    <div className='flex h-screen'>
        <section className='p-6 w-4/12'>
            <div onClick={handleProfile} className='flex gap-x-3 items-center cursor-pointer'>
            ...
            <div onClick={showMyStore} className='flex gap-x-3 items-center mt-5 justify-between cursor-pointer'>
                <div className='flex gap-x-3 items-center'>
